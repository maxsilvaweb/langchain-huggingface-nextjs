    ...
    <Card className="w-full h-[600px] md:h-[700px] flex flex-col shadow-xl bg-white/60 border-zinc-200 dark:border-white/5 dark:bg-black/20 backdrop-blur-sm">
      ...
      <CardFooter className="p-4 pt-0">
        <form onSubmit={handleSubmit} className="w-full">
          <div className="relative w-full rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm shadow-lg focus-within:ring-2 focus-within:ring-zinc-400/40 transition-all">
            <Textarea
              value={input}
